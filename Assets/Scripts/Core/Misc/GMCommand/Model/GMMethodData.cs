...
namespace Yu
{
    public class GMMethodData
    {
        ...
        public readonly string Catalog; //指令所属分类

        public GMMethodData(MethodInfo method, object instance, string catalog, string commandDesc, GMParameterData[] parametersData)
        {
            Catalog = catalog;
            Method = method;
            Instance = instance;
