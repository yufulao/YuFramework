...
public static class RabiFileUtil
{
    ...
    public static bool SafeDeleteFolder(string folder)
    {
        ...
        {
            GameLog.Error($"SafeDeleteDir failed! path = {folder} with err: {ex.Message}");
            return false;
        }
    }
    ...
    public static bool SafeDeleteFile(string filePath)
    {
        ...
        {
            GameLog.Error($"SafeDeleteFile failed! path = {filePath} with err: {ex.Message}");
            return false;
        }
    }
    ...
    public static bool SafeRenameFile(string sourceFileName, string destFileName)
    {
        ...
        {
            GameLog.Error($"SafeRenameFile failed! path = {sourceFileName} with err: {ex.Message}");
            return false;
        }
    }
