...
public class DraggableGridView<TData, TContext, TGroup> : GridView<TData, TContext, TGroup> where TContext : DraggableContext, new() where TGroup : GridGroup<TData, TContext>
{
    /// <summary>
    /// 初始化拖拽组件，需要手动初始化
    /// </summary>
    ...
    public void SetDragAction(Func<GameObject, bool> filter, Action<int> onBeginDrag = null,
        Action<int> onDrag = null, Action<int, List<GameObject>, Action<bool>> onEndDrag = null)
    {
